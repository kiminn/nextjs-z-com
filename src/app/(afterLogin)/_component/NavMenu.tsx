...
//내가 어떤 router에 있느지 어떻게 알 것인가?
export default function NavMenu() {
    //호출된 레이아웃보다 이전의 경로를 불러옴
    const segment = useSelectedLayoutSegment();
    // useSElectedLayoutSegment() : 바로 자식의 컴포넌트의 주소만 필요할 경우 폴더만!
    // useSelectedLayoutSegments() : 자식의 자식의 이름까지 가지고 올경우
    console.log('segment', segment);

    const me = {
        //나의정보가 위치 임시로 내정보가 있는 것 처럼
        id: 'kimi0',
    };
